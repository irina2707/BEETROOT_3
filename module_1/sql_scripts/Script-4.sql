...
-- 3. Countries (залежить від regions)
...
-- 4. Locations (залежить від countries)
...
-- 5. Departments (залежить від locations)
...
INSERT INTO employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id, Avg_Salary) VALUES
...
select first_name,last_name ,TRUNCATE(Salary,2) as RoundedSalary from employees ;
...
select employees.first_name,employees.last_name ,employees.department_id ,departments.depart_name from employees 
...
select employees.first_name,employees.last_name ,employees.department_id ,departments.depart_name,locations.city,locations.state_province from employees 
inner join departments on employees.department_id =departments.department_id
...
j.max_salary-e.salary as Differense
from jobs j
left join employees  e 
...
count(e.job_id) as employe_count
from departments d
left join employees e
on d.department_id =e.department_id
